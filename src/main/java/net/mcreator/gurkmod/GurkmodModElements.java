...
public class GurkmodModElements {
	...
	public GurkmodModElements() {
		...
		sounds.put(new ResourceLocation("gurkmod", "frozen_forest"),
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == GurkmodModElements.ModElement.class)
						elements.add((GurkmodModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(GurkmodModElements.ModElement::initElements);
	}
