...
public class HyjatPressurePlateBlock extends GurkmodModElements.ModElement {
	@ObjectHolder("gurkmod:hyjat_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("hyjat_pressure_plate");
		}
