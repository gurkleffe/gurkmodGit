...
public class MorelMushroomBlock extends GurkmodModElements.ModElement {
	@ObjectHolder("gurkmod:morel_mushroom")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("morel_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("gurkmod:morel_mushroom"), configuredFeature);
		}
	}
