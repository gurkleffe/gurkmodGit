...
public class HyjatStairsBlock extends GurkmodModElements.ModElement {
	@ObjectHolder("gurkmod:hyjat_stairs")
	public static final Block block = null;

	public HyjatStairsBlock(GurkmodModElements instance) {
		super(instance, 216);
	}
