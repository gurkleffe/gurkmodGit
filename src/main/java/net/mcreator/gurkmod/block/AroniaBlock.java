...
import net.mcreator.gurkmod.procedures.AroniaGrowProcedure;
...
public class AroniaBlock extends GurkmodModElements.ModElement {
	@ObjectHolder("gurkmod:aronia")
	public static final Block block = null;

	public AroniaBlock(GurkmodModElements instance) {
		super(instance, 294);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("aronia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("gurkmod:aronia"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			AroniaGrowProcedure.executeProcedure(Stream
