...
public class FrostwoodLogBlock extends GurkmodModElements.ModElement {
	@ObjectHolder("gurkmod:frostwood_log")
	public static final Block block = null;

	public FrostwoodLogBlock(GurkmodModElements instance) {
		super(instance, 9);
	}
