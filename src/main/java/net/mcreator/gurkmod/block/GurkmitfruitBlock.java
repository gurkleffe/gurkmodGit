...
public class GurkmitfruitBlock extends GurkmodModElements.ModElement {
	@ObjectHolder("gurkmod:gurkmitfruit")
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("gurkmitfruit"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			GurkOnBlockRightClickedProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("gurkmitfruit");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Gurk Stage 1");
		}
