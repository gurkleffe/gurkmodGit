...
public class MagmaperEntity extends GurkmodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -3394816, -26368, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("magmaper_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 9, 1, 1));
	}
	...
	public static class CustomEntity extends CreeperEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("gurkmod:magmaper_living_1"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("gurkmod:magmaper_living_2"));
		}
		...
		public void baseTick() {
			...
			MagmaperOnEntityTickUpdateProcedure.executeProcedure(Stream
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			MagmaperPlayerCollidesWithThisEntityProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
