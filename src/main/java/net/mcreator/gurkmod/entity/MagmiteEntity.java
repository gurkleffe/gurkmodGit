...
import net.mcreator.gurkmod.entity.renderer.MagmiteRenderer;
...
public class MagmiteEntity extends GurkmodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -52480, -52, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("magmite_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.strider.happy"));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.player.hurt_on_fire"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.snow_golem.death"));
		}
		...
		public void baseTick() {
			...
			MagmiteOnEntityTickUpdateProcedure.executeProcedure(Stream
