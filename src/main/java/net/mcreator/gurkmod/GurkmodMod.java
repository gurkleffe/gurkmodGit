 ...
 *
 *    Keep the GurkmodModElements object in this class and all calls to this object
...
@Mod("gurkmod")
public class GurkmodMod {
	public static final Logger LOGGER = LogManager.getLogger(GurkmodMod.class);
	...
	public GurkmodMod() {
		...
		MinecraftForge.EVENT_BUS.register(new GurkmodModFMLBusEvents(this));
	}
